...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/course/DS.css') }}">
@endsection

@section('scripts')
    <script src="{{ asset('js/course/DS.js') }}"></script>
@endsection
...
@section('content')
    ...
    <div class="container-fluid" style="margin:0;padding:0;box-sizing:border-box">
        ...
        <section id="infoSection" class="info p-4">
            <div class="container">
                <h1 class="python text-center  mb-5 mt-2">Data structure</h1>
                <p id="infoCollapse">
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-3">
                                        <ol>
                                            <li><a
                                                    href="{{ route('constructionsms', ['course' => 'data_structure', 'yt_link' => 'youtube_link_1']) }}">Youtube
                                                    Link</a></li>
                                        </ol>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-3">
                                        <ol>
                                            <li><a
                                                    href="{{ route('constructionsms', ['course' => 'data_structure', 'yt_link' => 'youtube_link_1']) }}">Website</a>
                                            </li>
                                        </ol>
                                    </td>
                                </tr>
